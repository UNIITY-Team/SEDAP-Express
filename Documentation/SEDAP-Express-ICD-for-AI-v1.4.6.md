# SEDAP-Express ICD v1.4.6 (AI-optimized reference)

Source: "SEDAP-Express ICD v1.4.6.docx". Content reproduced completely; formatting condensed for machine consumption.
...
### 6.6 TEXT
Human-readable text (alert or chat). If text may contain special characters (UTF-x, 0x0A, 0x23, …) it must be BASE64-encoded with Encoding indicator set; if indicator not set, no encoding is assumed. If linked to a contact, send the CONTACT message first.
...
"message":"METEO;2C;0191C643A8AF;74BE;U;;15.4;15.5;;;10.2;72;20.3;;55;1005;25;;;2500;33",
"message":"TEXT;56;0191C643A8AF;324E;S;;3;This is a chat message!;E4F1",
